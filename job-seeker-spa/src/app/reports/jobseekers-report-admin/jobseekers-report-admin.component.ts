...
@Component({
  selector: 'app-jobseekers-report-admin',
  templateUrl: './jobseekers-report-admin.component.html',
  styleUrls: ['./jobseekers-report-admin.component.css']
})
export class JobseekersReportAdminComponent implements OnInit {
  ...
  load() {
    ...
    this._adminService.getJobSeekersReport(this.searchKeys).subscribe(
      res => {
